...
exports.remove = exports.getOne = exports.list = exports.analyze = void 0;
const soilReportService = __importStar(require("./soilReport.service"));
...
exports.analyze = (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
    ...
    ApiResponse_1.default.created(res, report, 'Soil analysis complete.');
});
...
exports.getOne = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, report);
});
...
//# sourceMappingURL=soilReport.controller.js.map