...
exports.sendMessage = exports.remove = exports.getOne = exports.create = exports.list = void 0;
...
exports.create = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.created(res, session, 'Chat session started.');
});
exports.getOne = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, session);
});
...
exports.sendMessage = (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
    const { content, language } = req.body;
    const result = await chatSessionService.sendMessage(req.user.id, req.params.id, content, language);
    ApiResponse_1.default.created(res, result, 'Message sent.');
});
//# sourceMappingURL=chatSession.controller.js.map