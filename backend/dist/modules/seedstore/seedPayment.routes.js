...
const controller = __importStar(require("./seedPayment.controller"));
...
const seedPayment_validation_1 = require("./seedPayment.validation");
...
router.post('/create', (0, validate_1.default)({ body: seedPayment_validation_1.createSeedPaymentSchema }), controller.create);
router.post('/verify', (0, validate_1.default)({ body: seedPayment_validation_1.verifySeedPaymentSchema }), controller.verify);
router.get('/order/:orderId', (0, validate_1.default)({ params: orderIdParamSchema }), controller.getForOrder);
exports.default = router;
//# sourceMappingURL=seedPayment.routes.js.map