...
const controller = __importStar(require("./seedCategory.controller"));
...
router.post('/', authenticate_1.authenticate, (0, authorize_1.default)('ADMIN'), (0, validate_1.default)({ body: seed_validation_1.seedCategorySchema }), controller.create);
router.patch('/:id', authenticate_1.authenticate, (0, authorize_1.default)('ADMIN'), (0, validate_1.default)({ params: idParamSchema, body: seed_validation_1.seedCategorySchema.partial() }), controller.update);
...
//# sourceMappingURL=seedCategory.routes.js.map