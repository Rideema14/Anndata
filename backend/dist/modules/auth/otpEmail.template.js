...
function otpEmailHtml({ name, otp, purpose }) {
    ...
    const bodyLine = purpose === 'RESET_PASSWORD'
  ...
  <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; color: #1f2937;">
    ...
    <p>This code expires in ${env_1.env.otp.expiryMinutes} minutes. If you didn't request this, you can safely ignore this email.</p>
    <p style="margin-top: 32px; font-size: 12px; color: #6b7280;">Agri Marketplace</p>
  </div>`;
}
//# sourceMappingURL=otpEmail.template.js.map