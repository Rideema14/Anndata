...
const weatherService = __importStar(require("./weather.service"));
...
exports.getWeather = (0, asyncHandler_1.default)(async (req, res) => {
    const { lat, lng, days } = req.query;
    const weather = await weatherService.getWeather(lat, lng, days);
    ApiResponse_1.default.ok(res, weather);
});
