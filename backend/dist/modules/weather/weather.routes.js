...
const controller = __importStar(require("./weather.controller"));
 ...
 *         required: false
 */
router.get('/', (0, validate_1.default)({ query: weather_validation_1.weatherQuerySchema }), controller.getWeather);
