...
const productIdParamSchema = zod_1.z.object({ productId: zod_1.z.string().uuid() });
...
router.post('/:productId', (0, validate_1.default)({ params: productIdParamSchema }), (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
...
router.delete('/:productId', (0, validate_1.default)({ params: productIdParamSchema }), (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
