...
exports.cancel = exports.updateStatus = exports.getOne = exports.list = exports.create = void 0;
const bookingService = __importStar(require("./machineryBooking.service"));
const paymentService = __importStar(require("./machineryPayment.service"));
...
exports.create = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.created(res, { booking, payment }, 'Booking created. Proceed to payment.');
});
exports.list = (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
    const { items, meta } = await bookingService.listBookings(req.user, req.query);
...
exports.getOne = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, booking);
});
exports.updateStatus = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, booking, 'Booking status updated.');
});
exports.cancel = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, booking, 'Booking cancelled.');
});
//# sourceMappingURL=machineryBooking.controller.js.map