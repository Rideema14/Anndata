...
const controller = __importStar(require("./machineryCategory.controller"));
...
router.post('/', authenticate_1.authenticate, (0, authorize_1.default)('ADMIN'), (0, validate_1.default)({ body: machinery_validation_1.machineryCategorySchema }), controller.create);
router.patch('/:id', authenticate_1.authenticate, (0, authorize_1.default)('ADMIN'), (0, validate_1.default)({ params: idParamSchema, body: machinery_validation_1.machineryCategorySchema.partial() }), controller.update);
...
//# sourceMappingURL=machineryCategory.routes.js.map