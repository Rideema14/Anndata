...
exports.getCalendar = exports.getAnalytics = exports.getDashboard = void 0;
const analyticsService = __importStar(require("./machineryAnalytics.service"));
...
exports.getAnalytics = (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
    const analytics = await analyticsService.getAnalytics(req.user.id, req.query);
    ApiResponse_1.default.ok(res, analytics);
});
exports.getCalendar = (0, asyncHandler_1.default)(async (req, res) => {
    if (!req.user)
        throw ApiError_1.default.unauthorized('Authentication required.');
    const calendar = await analyticsService.getBookingCalendar(req.user.id, req.query);
    ApiResponse_1.default.ok(res, calendar);
});
//# sourceMappingURL=machineryAnalytics.controller.js.map