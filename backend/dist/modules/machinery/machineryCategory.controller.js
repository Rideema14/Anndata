...
const categoryService = __importStar(require("./machineryCategory.service"));
...
exports.create = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.created(res, category, 'Machinery category created.');
});
exports.update = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, category, 'Machinery category updated.');
});
exports.uploadImage = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    ApiResponse_1.default.ok(res, category, 'Machinery category image updated.');
});
...
//# sourceMappingURL=machineryCategory.controller.js.map