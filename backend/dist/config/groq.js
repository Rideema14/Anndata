...
exports.isGroqConfigured = void 0;
...
exports.isGroqConfigured = Boolean(env_1.env.groq.apiKey);
...
const groq = new groq_sdk_1.default({ apiKey: env_1.env.groq.apiKey || 'unset' });
